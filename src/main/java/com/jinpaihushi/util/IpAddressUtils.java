    ...
    public String getAddress(String params, String encoding) throws Exception {
        ...
        if (returnStr != null) {
            ...
            if ("0".equals(json.get("code").toString())) {
                ...
                //                buffer.append("国家:" + decodeUnicode(json.optJSONObject("data").getString("country")));//国家  

                //                buffer.append("\t地区:" + decodeUnicode(json.optJSONObject("data").getString("area")));//地区  

                buffer.append(decodeUnicode(json.optJSONObject("data").getString("region")));//省份  

                //                buffer.append("\t市区:" + decodeUnicode(json.optJSONObject("data").getString("city")));//市区  

                //                buffer.append("\t地区:" + decodeUnicode(json.optJSONObject("data").getString("county")));//地区  

                //                buffer.append("\tISP公司:" + decodeUnicode(json.optJSONObject("data").getString("isp")));//ISP公司  
